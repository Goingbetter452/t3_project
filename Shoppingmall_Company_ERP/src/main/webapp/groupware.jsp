<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.*, java.text.*, java.time.*, com.company1.dao.*, com.company1.dto.*"%>
<!DOCTYPE html>
<html lang="ko">
<head>
<meta charset="UTF-8">
...
<body>
	...
	<div class="groupware-container">
		...
		<!-- 공지사항 수정 모달 -->
		<div id="editNoticeModal" class="notice-edit-modal"
			style="display: none;">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="editNoticeTitle">제목</label> <input type="text"
							id="editNoticeTitle" maxlength="100">
					</div>
					<div class="form-group">
						<label for="editNoticeContent">내용</label>
						<textarea id="editNoticeContent" maxlength="500"></textarea>
					</div>
				</div>
				<div class="modal-footer">
					<button class="save-btn" onclick="updateNotice()">저장</button>
		...
		<div class="groupware-section messenger-section">
			...
			<div class="messenger-form">
				<select id="messageReceiver">
					...
					%>
					<option value="<%=emp.getEmpId()%>"><%=emp.getEmpName()%>
						(<%=emp.getEmpId()%>)
					</option>
					<%
					}
	...
	<script>
    <%String __cu = (String) session.getAttribute("loginUser");
if (__cu == null)
	__cu = "";%>
